...
safe(X/Y/S, []).
safe(X/Y/S, [X1/Y1/S1 |Tail]) :- S \== S1, safe(X/Y/S, Tail).
safe(X/Y/S, [X1/Y1/S1 |Tail]) :- S == S1, X \== X1, Y \==Y1, safe(X/Y/S, Tail). 
...
% S1.
next_state(misionari, state(est, Nm_est, Nc_est, Nm_vest, Nc_vest), state(vest, Nm_est1, Nc_est1, Nm_vest1, Nc_vest1)) :- safeMisionari(Nm_est1, Nc_est1), safeMisionari(Nm_vest1, Nc_vest1), Nm_est1 is Nm_est - 1, Nc_est1 is Nc_est - 1,
    Nm_vest1 is Nm_vest + 1, Nc_vest1 is Nc_vest + 1, Nc_est > 0, Nm_est > 0.
next_state(misionari, state(vest, Nm_est, Nc_est, Nm_vest, Nc_vest), state(est, Nm_est1, Nc_est1, Nm_vest1, Nc_vest1)) :- safeMisionari(Nm_est1, Nc_est1), safeMisionari(Nm_vest1, Nc_vest1), Nm_est1 is Nm_est + 1, Nc_est1 is Nc_est + 1,
    Nm_vest1 is Nm_vest - 1, Nc_vest1 is Nc_vest - 1, Nc_vest > 0, Nm_vest > 0.
next_state(misionari, state(vest, Nm_est, Nc_est, Nm_vest, Nc_vest), state(est, Nm_est1, Nc_est1, Nm_vest1, Nc_vest1)) :- safeMisionari(Nm_est1, Nc_est1), safeMisionari(Nm_vest1, Nc_vest1), Nm_est1 is Nm_est + 2, Nc_est1 is Nc_est + 0,
    Nm_vest1 is Nm_vest - 2, Nc_vest1 is Nc_vest - 0, Nm_vest > 1.
next_state(misionari, state(est, Nm_est, Nc_est, Nm_vest, Nc_vest), state(vest, Nm_est1, Nc_est1, Nm_vest1, Nc_vest1)) :- safeMisionari(Nm_est1, Nc_est1), safeMisionari(Nm_vest1, Nc_vest1), Nm_est1 is Nm_est - 2, Nc_est1 is Nc_est + 0,
    Nm_vest1 is Nm_vest + 2, Nc_vest1 is Nc_vest - 0, Nm_est > 1.
next_state(misionari, state(vest, Nm_est, Nc_est, Nm_vest, Nc_vest), state(est, Nm_est1, Nc_est1, Nm_vest1, Nc_vest1)) :- safeMisionari(Nm_est1, Nc_est1), safeMisionari(Nm_vest1, Nc_vest1), 
Nm_est1 is Nm_est + 1, Nc_est1 is Nc_est + 0,
    Nm_vest1 is Nm_vest - 1, Nc_vest1 is Nc_vest - 0, Nm_vest > 0.
next_state(misionari, state(est, Nm_est, Nc_est, Nm_vest, Nc_vest), state(vest, Nm_est1, Nc_est1, Nm_vest1, Nc_vest1)) :- safeMisionari(Nm_est1, Nc_est1), safeMisionari(Nm_vest1, Nc_vest1), 
Nm_est1 is Nm_est - 1, Nc_est1 is Nc_est + 0,
    Nm_vest1 is Nm_vest + 1, Nc_vest1 is Nc_vest - 0, Nm_est > 0.            


next_state(misionari, state(vest, Nm_est, Nc_est, Nm_vest, Nc_vest), state(est, Nm_est1, Nc_est1, Nm_vest1, Nc_vest1)) :- safeMisionari(Nm_est1, Nc_est1), safeMisionari(Nm_vest1, Nc_vest1), 
Nm_est1 is Nm_est + 0, Nc_est1 is Nc_est + 2,
    Nm_vest1 is Nm_vest - 0, Nc_vest1 is Nc_vest - 2, Nc_vest > 1.
next_state(misionari, state(est, Nm_est, Nc_est, Nm_vest, Nc_vest), state(vest, Nm_est1, Nc_est1, Nm_vest1, Nc_vest1)) :- safeMisionari(Nm_est1, Nc_est1), safeMisionari(Nm_vest1, Nc_vest1), 
Nm_est1 is Nm_est - 0, Nc_est1 is Nc_est - 2,
    Nm_vest1 is Nm_vest + 0, Nc_vest1 is Nc_vest + 2, Nc_est > 1.            

next_state(misionari, state(vest, Nm_est, Nc_est, Nm_vest, Nc_vest), state(est, Nm_est1, Nc_est1, Nm_vest1, Nc_vest1)) :- safeMisionari(Nm_est1, Nc_est1), safeMisionari(Nm_vest1, Nc_vest1), 
Nm_est1 is Nm_est + 0, Nc_est1 is Nc_est + 1,
    Nm_vest1 is Nm_vest - 0, Nc_vest1 is Nc_vest - 1, Nc_vest > 0.
next_state(misionari, state(est, Nm_est, Nc_est, Nm_vest, Nc_vest), state(vest, Nm_est1, Nc_est1, Nm_vest1, Nc_vest1)) :- safeMisionari(Nm_est1, Nc_est1), safeMisionari(Nm_vest1, Nc_vest1), 
Nm_est1 is Nm_est - 0, Nc_est1 is Nc_est - 1,
    Nm_vest1 is Nm_vest + 0, Nc_vest1 is Nc_vest + 1, Nc_est > 0.            
